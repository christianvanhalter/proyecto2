...
//traemos valor del botón de editar
$id = htmlentities($_GET['id']);

//realizamos consulta preparada SELECT:
$sel = $con->prepare("SELECT * FROM clientes WHERE id = ? ");
$sel->bind_param('i', $id);
$sel->execute();
$res = $sel->get_result();

//if para seleccionar los campos de esa consulta
    ...
    <div class="card">
      <div class="card-content">
        ...
        <form class="form" action="up_clientes.php" method="post" autocomplete=off >
        	<input type="hidden" name="id" value="<?php echo $id ?>"> <!--el $id se envía desde la lista de clientes que recibimos arriba-->
