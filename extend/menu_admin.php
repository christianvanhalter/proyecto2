	...
	<ul id="menu" class="side-nav fixed">
      ...
      <li><a class="dropdown-button" href="#!" data-activates="dropdown1">
      	<i class="material-icons">work</i>PROPIEDADES<i class="material-icons right">arrow_drop_down</i></a>
      </li>
		<li><div class="divider"></div></li>
	...
	<ul id="dropdown1" class="dropdown-content">
  		<li><a href="../propiedades/index.php?ope=VENTA">VENTA DE PASAJES</a></li>
	</ul>	