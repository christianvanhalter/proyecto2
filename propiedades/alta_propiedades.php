      ...
      <div class="card-content">
        ...
        <form  action="ins_propiedad.php" method="post" autocomplete="off" >
          ...
          <div class="row">
            ...
            <div class="col s6">
              <div class="res_estado"></div><!--DIV DE RESPUESTA DEL AJAX 'estados.js'-->
            </div>
          </div>
        ...
        <div class="row">
          <div class="col s6">
            ...
            <div class="input-field">
              ...
              <?php else: ?>
                <!--Si no, significa que el usuario es un ASESOR, entonces...-->
...
<!--SCRIPT PARA EJECUTAR EL AJAX DE ESTA PÁGINA-->
